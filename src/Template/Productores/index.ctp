 ...
 * @var \App\Model\Entity\Productor[]|\Cake\Collection\CollectionInterface $productores
 */
?>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $productor->id], ['confirm' => __('Are you sure you want to delete # {0}?', $productor->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
