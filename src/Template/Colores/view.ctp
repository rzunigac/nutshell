...
<div class="colores view large-9 medium-8 columns content">
    ...
    <div class="related">
        ...
        <?php if (!empty($color->fila_recepciones)): ?>
        <table class="table" cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($color->fila_recepciones as $filaRecepciones): ?>
            <tr>
    ...
    <div class="related">
        ...
        <?php if (!empty($color->ingreso_a_packing)): ?>
        <table class="table" cellpadding="0" cellspacing="0">
            <tr>
                <th scope="col"><?= __('Id') ?></th>
            ...
            <?php foreach ($color->ingreso_a_packing as $ingresoAPacking): ?>
            <tr>
    ...
    <div class="related">
        ...
        <?php if (!empty($color->salida_packing)): ?>
        <table class="table" cellpadding="0" cellspacing="0">
            <tr>
                <th scope="col"><?= __('Id') ?></th>
                <th scope="col"><?= __('Packing Id') ?></th>
            ...
            <?php foreach ($color->salida_packing as $salidaPacking): ?>
            <tr>
